    ...
    >
      ...
      <div className="relative">
        ...
        <div className="w-12 h-12 rounded-full backdrop-blur-md bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-purple-600/20 transition-all duration-300">
          {/* Initials */}
          <span className="text-white font-bold text-lg tracking-tighter">EOJ</span>
        </div>
      ...
      <div className="hidden md:block">
        ...
        >
          <div className="text-sm leading-tight">Ewuji Oluwaseyi</div>
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="w-12 h-12 rounded-full backdrop-blur-md bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-purple-600/20 transition-all duration-300">
          {/* Initials */}
          <span className="text-black font-bold text-lg tracking-tighter">EOJ</span>
        </div>
      ...
      <div className="hidden md:block">
        ...
        >
          <div className="text-sm leading-tight text-[#333]">Ewuji Oluwaseyi</div>
