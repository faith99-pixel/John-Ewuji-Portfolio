      ...
      <div className={`max-w-7xl mx-auto flex items-center justify-between backdrop-blur-lg bg-black/70 border border-white/10 rounded-xl p-4 transition-all duration-300 ${scrolled ? 'shadow-lg shadow-purple-500/10' : ''}`}>
        ...
        <div className="hidden md:flex items-center space-x-5">
          ...
          <button
            ...
            className={`${activeSection === "contact" ? "text-purple-400" : "text-gray-300 hover:text-purple-400"} cursor-pointer transition-colors px-3 py-1 rounded-lg hover:bg-white/5`}
          >
            Contact me
          </button>
        </div>
        ...
        {isMenuOpen && (
          <div className="absolute top-16 left-0 right-0 backdrop-blur-lg bg-black/80 border border-white/10 rounded-xl z-50 md:hidden p-4 flex flex-col space-y-2 mt-2">
            ...
            <button
              onClick={() => scrollToSection("contact")}
              className={`${activeSection === "contact" ? "text-purple-400 bg-white/5" : "text-gray-300"} text-left px-4 py-2 rounded-lg transition-colors`}
            >
              Contact me
            </button>
            <button
