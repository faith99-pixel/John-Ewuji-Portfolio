...
const Profile = (props: Props) => {
    ...
    return (
        <div className={`flex flex-col md:flex-row items-center gap-8 p-6 bg-gray-900 text-white min-h-screen overflow-hidden ${sectionPadding} backdrop-blur-lg bg-opacity-80 relative pt-40 md:pt-28`}>
            ...
            <div className="flex-1 space-y-6 relative z-10">
                ...
                <div className={`flex space-x-4 mb-2 pb-12 transition-all duration-700 delay-200 ${isLoaded ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'}`}>
                    <button className="bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-6 rounded transition-all duration-300 transform hover:scale-105 hover:shadow-lg relative overflow-hidden group">
